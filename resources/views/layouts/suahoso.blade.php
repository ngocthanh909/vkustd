                            ...
                            <div class="col-lg-6 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Enter email" disabled  value="{{$student->hodem.' '.$student->ten}}">
                            ...
                            <div class="col-lg-4 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" name="ma_bhyt" class="form-control" id="Mã BHYT"
                                        aria-describedby="emailHelp" placeholder="Mã BHYT" value="{{$student->ma_bhyt}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="dienthoai"
                                        aria-describedby="emailHelp" placeholder="Số điện thoại" value="{{$student->dienthoai}}">
                                </div>
                            </div>
                            <div class="col-lg-3 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="dienthoaigiadinh"
                                        aria-describedby="emailHelp" placeholder="Số điện thoại gia đình" value="{{$student->dienthoaigiadinh}}">
                                </div>
                            </div>
                            <div class="col-lg-3 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="email"
                                        aria-describedby="emailHelp" placeholder="Enter email" value="{{$student->email}}">
                                </div>
                            </div>
                            <div class="col-lg-3 detail-block">
                                ...
                                <div class="detail-content">
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="facebook"
                                        aria-describedby="emailHelp" placeholder="Enter email" value="{{$student->facebook}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
